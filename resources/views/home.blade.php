...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #hero.animate-in .hero-actions-wrap {
            opacity: 1;
            transform: translateY(0);
            filter: blur(0px);
        ...
        #hero.animate-out .hero-actions-wrap {
            opacity: 0;
            transform: translateY(-20px);
            filter: blur(6px);
            transition: transform 0.5s cubic-bezier(0.16, 1, 0.3, 1),
    ...
    <div class="hero-inner">
        ...
        <div>
            ...
            <div class="hero-actions-wrap">
                <a href="https://github.com/syarifahsanit" target="_blank" rel="noopener noreferrer" class="hero-github-pill" aria-label="Kunjungi Profil GitHub Syarif">
                    ...
                    <span class="gh-text">github.com/syarifahsanit</span>
